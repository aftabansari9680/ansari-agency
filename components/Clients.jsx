...
const Clients = () => {
  ...
  return (
    <div className="text-white bg-black flex gap-10 py-5 px-5 pb-10 max-sm:flex-wrap max-md:flex-wrap ">
      {clients.map((item) => (
        <div className="text-center flex flex-col gap-10 py-10 px-10 border-2 hover:border-[#9fe9ef] border-[#0b373a] rounded-2xl bg-[#04191e] hover:bg-[#04090a] duration-300">
          <div>{item.name}</div>
