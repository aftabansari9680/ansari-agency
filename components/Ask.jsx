...
const Ask = () => {
  ...
  return (
    ...
    {Ask.map((item,index) => (
      <div key={index} className="bg-slate-800 text-white flex flex-col items-center gap-5  py-6 rounded-2xl border-2 hover:border-[#2e8e9d] duration-300 border-[#373737]">
        <div>{item.media}</div>
