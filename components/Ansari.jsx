...
const Ansari = () => {
  return (
    <div>
      <div
        className="text-white bg-black  flex flex-col items-center gap-8 py-4 px-10"
        id="#AboutUs"
      >
        ...
        <div className="text-center">
          ...
          in the digital landscape. Collaborate with us and let&apos;s bring
          your vision to life with creativity, precision, and ingenuity.
        </div>
        <div>
